...
[("3D View",
  ...
  {"items":
   [("view3d.rotate_canvas", {"type": 'MIDDLEMOUSE', "value": 'PRESS', "ctrl": True, "alt": True}, None),
    ...
    ("obj.ori_to_selected", {"type": 'C', "value": 'PRESS', "shift": True, "ctrl": True}, None),
    ("wm.call_menu",
    ...
    ("view3d.select_circle", {"type": 'C', "value": 'PRESS', "shift": True}, None),
 ...
 ("Armature",
  ...
  {"items":
   [("armature.reveal", {"type": 'H', "value": 'PRESS', "alt": True}, None),
    ...
    ("armature.parent_set", {"type": 'C', "value": 'PRESS', "alt": True}, None),
    ("armature.parent_clear", {"type": 'C', "value": 'PRESS', "shift": True, "alt": True}, None),
    ("armature.select_all",
     {"type": 'A', "value": 'PRESS'},
     {"properties":
      [("action", 'SELECT'),
    ...
    ("armature.dissolve", {"type": 'X', "value": 'PRESS', "shift": True}, None),
    ...
    ("armature.fill", {"type": 'C', "value": 'PRESS'}, None),
 ...
 ("Clip Editor",
  ...
  {"items":
   [("clip.view_pan", {"type": 'MIDDLEMOUSE', "value": 'PRESS'}, None),
    ...
    ("clip.select_circle", {"type": 'C', "value": 'PRESS', "shift": True}, None),
    ("wm.call_menu",
 ...
 ("Curve",
  ...
  {"items":
   [("wm.call_menu",
    ...
    ("curve.make_segment", {"type": 'C', "value": 'PRESS'}, None),
    ...
    ("curve.dissolve_verts", {"type": 'X', "value": 'PRESS', "shift": True}, None),
 ...
 ("Dopesheet",
  ...
  {"items":
   [("wm.call_menu_pie",
     {"type": 'F', "value": 'PRESS', "shift": True},
     {"properties":
      [("name", 'FR_TU_MT_Frame_Modal_Pie'),
       ],
      },
     ),
    ("anim.change_frame", {"type": 'RIGHTMOUSE', "value": 'PRESS', "alt": True}, None),
    ("action.clickselect",
     {"type": 'LEFTMOUSE', "value": 'PRESS'},
     {"properties":
      [("deselect_all", True),
    ...
    ("action.select_circle", {"type": 'C', "value": 'PRESS', "shift": True}, None),
    ...
    ("action.view_all", {"type": 'F', "value": 'PRESS', "shift": True}, None),
 ...
 ("Font",
  ...
  {"items":
   [("font.style_toggle",
    ...
    ("font.text_cut", {"type": 'X', "value": 'PRESS', "shift": True, "ctrl": True}, None),
 ...
 ("Graph Editor",
  ...
  {"items":
   [("wm.call_menu_pie",
    ...
    ("graph.cursor_set", {"type": 'RIGHTMOUSE', "value": 'PRESS', "alt": True}, None),
    ("wm.context_toggle",
     {"type": 'H', "value": 'PRESS', "ctrl": True},
     {"properties":
    ...
    ("graph.select_circle", {"type": 'C', "value": 'PRESS', "shift": True}, None),
    ("graph.select_column",
     {"type": 'K', "value": 'PRESS'},
     {"properties":
      [("mode", 'KEYS'),
    ...
    ("graph.view_all", {"type": 'F', "value": 'PRESS', "shift": True}, None),
 ...
 ("Grease Pencil Stroke Edit Mode",
  ...
  {"items":
   [("gpencil.interpolate", {"type": 'E', "value": 'PRESS', "ctrl": True}, None),
    ...
    ("gpencil.select_circle", {"type": 'C', "value": 'PRESS', "shift": True}, None),
    ...
    ("gpencil.dissolve", {"type": 'X', "value": 'PRESS', "shift": True}, None),
 ...
 ("Image",
  ...
  {"items":
   [("image.view_all", {"type": 'HOME', "value": 'PRESS'}, None),
    ...
    ("image.view_cursor_center", {"type": 'C', "value": 'PRESS', "shift": True, "ctrl": True}, None),
 ...
 ("Mask Editing",
  ...
  {"items":
   [("mask.new", {"type": 'N', "value": 'PRESS', "alt": True}, None),
    ...
    ("mask.select_circle", {"type": 'C', "value": 'PRESS', "shift": True}, None),
    ("mask.select_lasso",
     {"type": 'RIGHTMOUSE', "value": 'CLICK_DRAG', "ctrl": True, "alt": True},
     {"properties":
      [("mode", 'ADD'),
 ...
 ("Mesh",
  ...
  {"items":
   [("mesh.select_box_xray",
    ...
    ("transform.vert_slide", {"type": 'Z', "value": 'PRESS', "shift": True}, None),
    ...
    ("mesh.dissolve_mode", {"type": 'X', "value": 'PRESS', "shift": True}, None),
    ...
    ("mesh.subdivide", {"type": 'D', "value": 'PRESS', "repeat": True}, None),
    ],
   },
  ),
 ("Metaball",
 ...
 ("Node Editor",
  ...
  {"items":
   [("wm.call_menu",
    ...
    ("node.select_circle", {"type": 'C', "value": 'PRESS', "shift": True}, None),
    ("node.link",
     {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG'},
     {"properties":
      [("detach", False),
    ...
    ("node.view_all", {"type": 'F', "value": 'PRESS', "shift": True}, None),
    ...
    ("node.delete_reconnect", {"type": 'X', "value": 'PRESS', "shift": True, "ctrl": True}, None),
 ...
 ("Object Mode",
  ...
  {"items":
   [("object.select_box_xray",
    ...
    ("object.parent_set", {"type": 'C', "value": 'PRESS', "alt": True}, None),
    ("object.parent_clear", {"type": 'C', "value": 'PRESS', "shift": True, "alt": True}, None),
 ...
 ("Screen",
  ...
  {"items":
   [("screen.animation_step", {"type": 'TIMER0', "value": 'ANY', "any": True}, None),
    ...
    ("screen.repeat_last", {"type": 'R', "value": 'PRESS', "shift": True, "ctrl": True, "repeat": True}, None),
    ...
    ("ed.undo", {"type": 'Y', "value": 'PRESS', "ctrl": True, "repeat": True}, None),
    ("ed.redo", {"type": 'X', "value": 'PRESS', "ctrl": True, "repeat": True}, None),
    ("render.render",
 ...
 ("Text",
  ...
  {"items":
   [("wm.context_cycle_int",
    ...
    ("text.cut", {"type": 'X', "value": 'PRESS', "shift": True, "ctrl": True}, None),
 ...
 ("UV Editor",
  ...
  {"items":
   [("uv.toolkit_scale_individual_origins", {"type": 'S', "value": 'PRESS', "alt": True}, None),
    ...
    ("uv.select_circle", {"type": 'C', "value": 'PRESS', "shift": True}, None),
    ("uv.select_lasso",
     {"type": 'RIGHTMOUSE', "value": 'CLICK_DRAG', "ctrl": True},
     {"properties":
      [("mode", 'ADD'),
